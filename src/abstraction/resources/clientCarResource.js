...
export const getJson = (data) => ({
    ...
    clientCarStatus: getJsonClientCarStatus(data.clientCarStatus ? data.clientCarStatus : {}),
    clientCarStatuses: getArrayClientCarStatus(data.clientCarStatuses ? data.clientCarStatuses : []),
});
...
export const setData = (data) => ({
    ...
    third_party_insurance: data.third_party_insurance ? data.third_party_insurance : 0,
    original_price: data.original_price,
    price: data.price,
    features: data.features,
    color_id: data.color_id,
