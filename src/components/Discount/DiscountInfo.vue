  ...
  <div>
    ...
    >
      <v-card-text>
        ...
        <DiscountInfoItem
          name_fa="قابل استفاده"
          :value="discount.number_uses + ' بار'"
        />
        <DiscountInfoItem
          name_fa="حداقل مبلغ خرید"
          :value="discount.min_purchase + ' تومان'"
        />
        <router-link
          :to="{ name: 'userDetails', params: { id: discount.user_id } }"
        >
          <DiscountInfoItem
