...
<template>
    <BaseModal :dialog="dialog" title="ویرایش خودرو" subtitle="EDIT CAR" icon="mdi-car-side"
        ...
        <v-card-text>
                ...
                <v-row>
                    <v-col cols="12" md="4" sm="12">
                        <v-select variant="underlined" label="برند خودرو" name="brand" :items="getBrands" item-value="id" item-text="name_fa"
                            prepend-icon="mdi-car-side" v-model="car.brand_id"></v-select>
                    </v-col>
                    <v-col cols="12" md="4" sm="12">
