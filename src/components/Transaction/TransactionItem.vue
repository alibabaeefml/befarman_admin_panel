...
<template>
    <div>
        <v-card class="border mt-3 text-center" :color="outgoing ? '#ee35521a' : '#32cad51a'">
            <v-card-text dir="rtl" class="yl">
                <v-row class="align-center">
                    <v-col cols="12" md="4" xs="12" class="d-flex justify-center flex-column"
                        :style="{ background: outgoing ? '#ee3552' : '#32cad5', color: 'white', height: '150px' }">
                        <h1 dir="ltr" class="mb lg-txt">{{ outgoing ? '-' : '+' }} 5000000</h1>
                        <h2>تومان</h2>
                    </v-col>
            ...
            <v-card-actions style="position:absolute;bottom:0">
                ...
                <v-btn v-else color="orange" icon @click="restoreCar">
                    ...
                    <v-tooltip v-if="archived" activator="parent" location="bottom">بازگشت تراکنش</v-tooltip>
                </v-btn>
